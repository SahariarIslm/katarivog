...
Route::prefix('admin')->group(function()
{
	...
	Route::group(['middleware'=>'menuPermission'],function(){
		Route::get('/','Admin\UserHomeController@index')->name('admin.index');
		...
		Route::get('/product-section', 'Admin\ProductSectionController@index')->name('productsection.index');
		Route::match(['GET', 'POST'], '/product-section/add', 'Admin\ProductSectionController@add')->name('productsection.add');
		Route::match(['GET', 'POST'],'/product-section/edit/{id}', 'Admin\ProductSectionController@edit')->name('productsection.edit');
		Route::get('/product-section/status/{id}', 'Admin\ProductSectionController@status')->name('productsection.status');
		Route::match(['GET', 'POST'],'/product-section/delete/{id}', 'Admin\ProductSectionController@delete')->name('productsection.delete');
		...
		*/
		...
		Route::get('/user-menu-link-edit/{menuId}/{actionMenuId}', 'Admin\UserMenuController@usermenuLinkEdit')->name('userMenu.ActionLinkEdit');
		...
		Route::get('/user-add', 'Admin\UserController@adduser')->name('useradd.page');

		Route::post('/user-save', 'Admin\UserController@saveuser')->name('user.save');

		Route::get('/user/status/{id}', 'Admin\UserController@changeuserStatus')->name('user.changeuserStatus');

		Route::get('/user-edit/{id}', 'Admin\UserController@edituser')->name('user.edit');

		Route::post('/user-upate', 'Admin\UserController@updateuser')->name('user.update');
		Route::get('/user-password/{id}', 'Admin\UserController@password')->name('user.password');

		Route::get('/user-profile/{id}', 'Admin\UserController@userProfile')->name('user.profile');

		Route::post('/user-changePassword', 'Admin\UserController@passwordChange')->name('user.changePassword');

		Route::get('/user-account', 'Admin\UserController@UserAccount')->name('user.account');
		Route::get('/user-account-password/{id}', 'Admin\UserController@password')->name('userAccount.password');
...
// Report Section Start
    ...
    Route::post('/logout', 'Auth\UserLoginController@adminLogout')->name('admin.logout');

    // Password Reset Routes...
     Route::get('/password/reset', 'Auth\UserForgotPasswordController@passwordForget')->name('admin.password.forget');
     Route::post('/password/email', 'Auth\UserForgotPasswordController@passwordEmail')->name('admin.password.email');
     Route::get('/new-password/{email}', 'Auth\UserForgotPasswordController@newPassword')->name('admin.password.newPassword');
     Route::post('/password/save', 'Auth\UserForgotPasswordController@changePasswordSave')->name('admin.password.save');
...
Route::get('/category/{id}/{name}', 'CategoryController@ProductByCategory')->name('category.product');
...
//Customer Review here
Route::post('/customer-review', 'ReviewController@customerReview')->name('customerReview.save');

Route::post('/subscriber-email-save', 'NewsletterController@SubscriberEmailSave')->name('subscriberEmailSave');

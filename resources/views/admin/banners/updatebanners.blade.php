...
@section('content')
    <form class="form-horizontal" action="{{ route('banner.update') }}" method="POST" enctype="multipart/form-data" id="editBanner" name="editBanner">
        ...
        <div class="form-group row {{ $errors->has('title') ? ' has-danger' : '' }}">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control form-control-danger" placeholder="banner title" name="title" value="{{ $banners->title }}">
                @if ($errors->has('title'))
        ...
        <div class="form-group row {{ $errors->has('bannerImage') ? ' has-danger' : '' }}">
            ...
            <div class="col-sm-9">
                ...
                <span class="imageSizeInfo">/* Standard Image Size : 850*215 */ <br></span>

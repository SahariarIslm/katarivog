            ...
            <div class="row">
            	<div class="col-md-6">
            		...
            		<select class="form-control chosen-select" name="sections[]" data-placeholder="Select Product Section" multiple>
            			@foreach ($product_section_list as $product_section)s
                        ...
                        <div class="col-md-3">
                            <div class="form-check-inline">
                                <label class="form-check-label" for="hotInput">
                                    <input class="form-check-input" type="checkbox" name="hotDeal" value="1" id="hotInput">
                                    Hot Deal
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-check-inline">
                                <label class="form-check-label" for="specialInput">
                                    <input class="form-check-input" type="checkbox" id="specialInput" name="specialDeal" value="1">
                                    Special Deal
                                </label>
                            </div>
                        </div>

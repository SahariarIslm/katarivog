...
@section('content')
    <form class="form-horizontal" action="{{ route('testimonial.add') }}" method="POST" enctype="multipart/form-data" id="newProduct" name="newProduct">
        ...
        {{-- <div class="form-group row {{ $errors->has('department') ? ' has-danger' : '' }}">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control form-control-danger" placeholder="department" name="department" value="{{ old('department') }}">
        ...
        <div class="form-group row {{ $errors->has('institute') ? ' has-danger' : '' }}">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control form-control-danger" placeholder="institute" name="institute" value="{{ old('institute') }}">
       ...
       {{--  <div class="form-group row {{ $errors->has('country') ? ' has-danger' : '' }}">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control form-control-danger" placeholder="country" name="country" value="{{ old('country') }}">

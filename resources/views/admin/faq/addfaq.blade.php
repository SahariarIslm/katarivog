...
<form class="form-horizontal" action="{{ route('faq.save') }}" method="POST" enctype="multipart/form-data" id="newFaq" name="newFaq">
    ...
    <div class="form-group row {{ $errors->has('title') ? ' has-danger' : '' }}">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control form-control-danger" placeholder="write your qusetion" name="title" value="{{ old('title') }}" required>
            @if ($errors->has('title'))
    ...
    <div class="form-group row {{ $errors->has('description') ? ' has-danger' : '' }}">
        ...
        <div class="col-sm-10">
            <textarea class=" form-control form-control-danger tinymce" name="description" value="{{ old('description') }}" style="min-height: 400px;">{{ old('description') }}</textarea>
        ...
        <div class="col-sm-10 row">
            <div class="form-control">
                <div class="custom-control custom-radio">
                    <input type="radio" id="published" name="status" class="custom-control-input" value="1" checked="" required>

...
class OrderController extends Controller
{
    ...
    public function downloadInvoices($orderId){
        ...
        $orders = Order::select('orders.*', 'products.name','product_advance.free_shipping', 'products.deal_code')
                    ->join('products', 'products.id', '=', 'orders.product_id')
                     ->join('product_advance', 'product_advance.productId', '=', 'orders.product_id')

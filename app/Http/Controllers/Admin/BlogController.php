    ...
    public function status(Request $request)
    {
     ...
     public function saveblog(Request $request){
        if (isset($request->firstHomeImage)) {
            $firstHomeImage = \App\HelperClass::UploadImage($request->firstHomeImage,'blogs','public/uploads/blogs/home/','780','430');
        }

         if (isset($request->firstInnerImage)) {
            $firstInnerImage = \App\HelperClass::UploadImage($request->firstInnerImage,'blogs','public/uploads/blogs/inner_page/','780','430');
        }

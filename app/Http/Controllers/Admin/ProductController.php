...
class ProductController extends Controller
{
    ...
    public function addproduct(){
        ...
        return view('admin.product.add')->with(compact('title','tab1','tab1Link','tab2','tab2Link','tab3','tab3Link','tab4','tab4Link','buttonName','categories','product_section_list','relatedProducts','customer_groups','productId'));
    }
     ...
     public function editProduct($productId)
    {
        ...
        $productAdvance = ProductAdvance::where('productId',$productId)->first();
        $productImages = ProductImage::where('productId',$productId)->get();

        return view('admin.product.edit')->with(compact('title','tab1','tab1Link','tab2','tab2Link','tab3','tab3Link','tab4','tab4Link','buttonName','categories','product_section_list','relatedProducts','product','productAdvance','productImages','customer_groups','customerGroup','productId'));
    }
    ...
    public function updateProductAdvanceInfo(Request $request)
    {
        ...
        if($request->hotDeal == null){
            $request->hotDiscount = '';
            $request->hotDate = '';
        }

        if($request->specialDeal == null){
        ...
        if ($type == "add")
        {
            ...
            return redirect(route('productadd.page',[$productId,'productAdvance'=>$productAdvance]))->with('msg',$msg)->withInput(); 
        }
    ...
    public function updateProductSeoInfo(Request $request)
    {
        ...
        if ($type == "add")
        {
            ...
            return redirect(route('productadd.page',[$productId,'productAdvance'=>$productAdvance,'productSeo'=>$productSeo]))->with('msg',$msg)->withInput();
        }
    ...
    public function saveProductImage(Request $request)
    {
        ...
        if (isset($request->productImage)){
           ...
           $mainImage = ProductImage::create( [
            ...
            $contentImage = \App\HelperClass::UploadImage($request->productImage,'product_images','images/products/'.$product->name."/"."content_image/",'915','1000');
     ...
     public function deleteProductImage(Request $request)
    {
        ...
        if($image->delete() && $otherImage->delete())
        {
    ...
    {   $imageSction = ProductImage::where('productId',$request->product_id)->get();
        ...
        {   foreach ($imageSction as $singleImage) {
            ...
            ProductAdvance::where('productId',$request->product_id)->delete();
    ...
    public function deleteProduct($id){
     ...
     public function FlashSell(){
        ...
        return view('admin.product.flashSell')->with(compact('productsAll','flashProducts','title'));
    }
